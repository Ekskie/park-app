...
export default function AuthScreen() {
  ...
  const checkLoginStatus = useCallback(async () => {
    try {
      ...
      if (storedEmail) {
        // The root _layout.tsx usually handles this, but this is a double-check
  ...
  const handleAuth = async () => {
    ...
    try {
      if (login) {
        ...
        if (data.session) {
          // _layout.tsx will likely handle the redirect, but we leave this for immediate feedback
          router.replace("/(tabs)/detect");
        }
